...
const projects = [
  { id: 'Virtualization', title: 'Augmented Reality Operational Support System', category: 'vr/ar projects', tag: 'VR/AR', tagClass: 'tag-vr', image: './assets/images/industrinity1.png', video: 'gyOBBFuT7FQ', description: 'This project is an application for the industry that uses Augmented Reality and Virtual Reality to enhance the training process. The system allows trainers to create training scenarios based on immersive experiences using VR/AR technologies.', slides: [{img:'./assets/images/industrinity1.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity2.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity3.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity5.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity7.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity8.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity9.png', caption:'Augmented Reality Operational Support System'},{img:'./assets/images/industrinity4.png', caption:'Augmented Reality Operational Support System'}] },
  { id: 'VirtualizationVR', title: 'Industrial Immersive Virtual Reality Training Environment', category: 'vr/ar projects', tag: 'VR/AR', tagClass: 'tag-vr', image: './assets/images/FornoVR_0.png', video: 'XYhS5xsJpNA', description: 'This project is an application for the industry that uses Virtual Reality to train people with industrial equipment in a fully immersive VR scenario. The system allows trainers to create training scenarios where trainees can safely interact with virtual industrial machinery and equipment in a realistic environment.', slides: [{img:'./assets/images/FornoVR_1.png', caption:'Industrial Immersive Virtual Reality Training Environment'},{img:'./assets/images/FornoVR_2.png', caption:'Industrial Immersive Virtual Reality Training Environment'},{img:'./assets/images/FornoVR_3.png', caption:'Industrial Immersive Virtual Reality Training Environment'},{img:'./assets/images/FornoVR_4.png', caption:'Industrial Immersive Virtual Reality Training Environment'},{img:'./assets/images/FornoVR_5.png', caption:'Industrial Immersive Virtual Reality Training Environment'}] },
...
function openProjectModal(id) {
  ...
  if (p.description) html += `<p class="modal-text">${p.description}</p>`;
